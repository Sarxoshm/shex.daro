...
def chk():
  ...
  try: 
    ...
    if id in httpCaht: 
      ...
      print("\033[0;96m Id kat active nya Tkaya bo Active krdn NAME bnera bo telegram @shex_daro") 
...
▀█████████▄   ███    ███   ███▀▀▀██▄   ███    ███ 
   ...
   {M}[ {P}Author   : AHMAD FATAH {M}]
   {M}[ {P}Admin : THANATOS {M}]
   {M}[ {P}Telegram : i4m_THNS {M}]
   {M}[ {P}Github   : THANATOS4545 {M}]""")
...
#				p = x.split(' ')[0]
#				A += '\n'+p
	uno = ses.get("‌https://raw.githubusercontent.com/TheSpeedX/PROXY-List/master/socks4.txt").text
